...
const REFERENCE_ACCURACY_INSTRUCTIONS = `Reference Accuracy (Critical):
Use the provided reference garment image as the sole source for the garment's appearance.
Faithfully reproduce: exact color(s), fabric type, fabric texture, embroidery, pattern placement, stitching style, decorative details, buttons, collar/neckline design, sleeve design, cuff details, trim, borders, and overall craftsmanship.
Do not invent, simplify, exaggerate, or redesign any clothing details.

Preserve Everything Else:
Do not modify background, lighting direction, shadows, camera angle, framing, composition, or image quality. Only replace the clothing.

Image Quality:
Produce a highly realistic, photorealistic fashion edit with natural fabric physics, accurate textile rendering, fine embroidery detail, realistic stitching, professional fashion photography quality, natural lighting, and sharp focus. No visible signs of AI editing or clothing replacement.`;
...
Clothing Replacement:
Replace the existing clothing with a traditional shalwar kameez set — a kameez (tunic) paired with matching shalwar trousers, with an optional dupatta styled naturally over the shoulder if suggested by the reference image.
